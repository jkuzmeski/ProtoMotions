...
#
"""Biomechanics evaluation config for SMPL lower-body box feet on Newton."""
...
def _load_base_experiment():
    module_path = Path(__file__).with_name("smpl_lower_body_box_feet.py")
    spec = spec_from_file_location("smpl_lower_body_box_feet_base", module_path)
